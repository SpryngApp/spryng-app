...
export default function SignupPage() {
  ...
  const next = useMemo(() => sp.get("next") || "/onboarding", [sp]);
  ...
  async function signUpWithEmail(e: React.FormEvent) {
    ...
    try {
      ...
      // If you have email confirmation enabled, Supabase will send a link.
      // This URL should be allowed in Supabase Auth settings.
      ...
      if (!data.session) {
        setNotice("Check your email to confirm your account, then you’ll be brought back to Spryng.");
        setLoading(null);
        return;
      }

      // If confirmations are OFF, you may already be signed in:
    ...
    <main className="mx-auto flex min-h-[calc(100vh-0px)] max-w-md flex-col justify-center px-6 py-16">
      <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-3 text-sm text-slate-600">
          Save your employer setup steps, upload confirmations, and stay on top of deadlines.
        </p>
